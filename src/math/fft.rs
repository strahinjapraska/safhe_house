...
pub fn fft(a: &Vec<Integer> , n: usize, w: &Integer, p: &Integer) -> Vec<Integer>{
...
pub fn ifft(a: &Vec<Integer> , n: usize, w: &Integer, p: &Integer) -> Vec<Integer>{
    let w_inv = w.clone().invert(p).expect("No inverse for w mod p");
